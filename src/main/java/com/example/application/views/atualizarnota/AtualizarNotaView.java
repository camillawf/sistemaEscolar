package com.example.application.views.atualizarnota;
...
@Route(value = "AtualizarNota", layout = MainLayout.class)
@Uses(Icon.class)
public class AtualizarNotaView extends Composite<VerticalLayout> {

    public AtualizarNotaView() {
        ...
        buttonPrimary.addClickListener(e -> {
            ...
            AtualizarNotaToDatabase(matricula, periodo, descricao, nota);
        });
    ...
    private Connection AtualizarNotaToDatabase(String matricula, String periodo, String descricao, String nota){
        ...
        try {
            ...
            String insertQuery = "UPDATE nota SET nota = ? WHERE Matricula = ? AND Descricao = ? AND Periodo =  ?";
            ...
            connection.close();
            Notification.show("Nota atualizada com sucesso");
        } catch (SQLException e) {
            // Handle database error and show an error message
            Notification.show("Erro ao atualizar nota");
            e.printStackTrace();
        }
        return connection;
    }}
