package com.example.application.views.visualizarAlunos;
...
@PageTitle("Visualizar Alunos")
@Route(value = "VisualizarAlunos", layout = MainLayout.class)
@Uses(Icon.class)
public class VisualizarAlunosView extends Composite<VerticalLayout> {

    public VisualizarAlunosView() {
        ...
        buttonPrimary.addClickListener(e -> {
            ...
            visualizarNotaToDatabase(matricula);
        });
    ...
    private Connection visualizarNotaToDatabase(String matricula){
        ...
        try {
            ...
            String insertQuery = "SELECT * FROM nota WHERE matricula = ?";
