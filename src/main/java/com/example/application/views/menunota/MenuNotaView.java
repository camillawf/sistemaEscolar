package com.example.application.views.menunota;
...
@PageTitle("Menu Notas")
@Route(value = "MenuNotas", layout = MainLayout.class)
@Uses(Icon.class)
public class MenuNotaView extends Composite<VerticalLayout> {
    ...
    public MenuNotaView() {
        ...
        buttonPrimary.setText("Atualizar Notas");
        buttonPrimary.setWidthFull();
        buttonPrimary.addThemeVariants(ButtonVariant.LUMO_PRIMARY);
        buttonPrimary.addClickListener(event -> {
            UI.getCurrent().navigate("AtualizarNota");
        });
        ...
        buttonPrimary2.setText("Deletar Notas");
        buttonPrimary2.setWidthFull();
        buttonPrimary2.addClickListener(event -> {
            UI.getCurrent().navigate("DeletarNota");
        });
        ...
        buttonPrimary3.setText("Inserir Notas");
        buttonPrimary3.setWidthFull();
        buttonPrimary3.addClickListener(event -> {
            UI.getCurrent().navigate("InserirNota");
        });
        ...
        buttonPrimary4.setText("Visualizar Notas");
        buttonPrimary4.setWidthFull();
        buttonPrimary4.addClickListener(event -> {
            UI.getCurrent().navigate("VisualizarNota");
        });
