package com.example.application.views.deletarnota;
...
@PageTitle("Deletar Nota")
@Route(value = "DeletarNota", layout = MainLayout.class)
@Uses(Icon.class)
public class DeletarNotaView extends Composite<VerticalLayout> {

    public DeletarNotaView() {
        ...
        h2.setText("Insira as informações do aluno que deseja deletar a nota:");
        ...
        buttonPrimary.addClickListener(e -> {
            ...
            deleteNotaToDatabase(matricula, periodo, descricao, nota);
        });
    ...
    private Connection deleteNotaToDatabase(String matricula, String periodo, String descricao, String nota){
        ...
        try {
            ...
            String insertQuery = "DELETE FROM nota WHERE Matricula = ? AND nota = ? AND Descricao = ? AND Periodo =  ?";
            ...
            connection.close();
            Notification.show("Nota deletada com sucesso");
        } catch (SQLException e) {
            // Handle database error and show an error message
            Notification.show("Erro ao deletar nota");
            e.printStackTrace();
        }
        return connection;
    }}
